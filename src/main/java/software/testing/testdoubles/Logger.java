...
public interface Logger {
	 ...
	 * define a default software.testing.testdoubles.LogLevel. This method can then
	 * be used to change that software.testing.testdoubles.LogLevel.
	 * 
	 ...
	 * if the current software.testing.testdoubles.LogLevel is set to the specified level
	 * or higher. 
	 * 
	 * @param level The specified log level. 
